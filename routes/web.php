...
use Alliswell\Appyhp\Http\Middleware\EnsureStudioAccess;
...
Route::middleware($studioMiddleware)->group(function (): void {
    Route::get('/appyhp/studio', StudioController::class)->name('appyhp.studio');
    ...
    Route::middleware(ValidateCsrfToken::class)->group(function (): void {
        Route::prefix('/appyhp/api/ai')->name('appyhp.ai.')->group(function (): void {
        ...
        Route::prefix('/appyhp/api/directories')->name('appyhp.directories.')->group(function (): void {
            ...
            Route::post('/relocate', [DirectoryController::class, 'relocate'])->name('relocate');
